...
```{r vote-share-size-fig, fig.cap="Fraud, winning vote-share, and median protest size", fig.height=7}
...
```{r vote-share-fig, fig.cap="Fraud, winning vote-share, and number of protest events"}
