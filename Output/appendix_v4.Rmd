...
models4 <- list()
models4[['Model 5']] <- model.n.base2.succ
#models4[['Model 6']] <- model.d.base2.hurd
models4[['Model 6']] <- model.size.base2
...
t6a <- huxreg(models5, tidy_args = c("component" = "cond"), borders = 0, number_format = 2,  omit_coefs = c("sd__(Intercept)", "sd__Observation"), statistics = character(0)) %>% set_caption("Table XX: Models of number and size of protests, inclu. liberal democracies") %>% insert_row("", "Number", "Size", after = 0)
