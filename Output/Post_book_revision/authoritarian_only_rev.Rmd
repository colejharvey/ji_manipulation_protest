...
## Testing H2: Manipulation and protest risk

I conduct this analysis in two ways. In the first, I generate a propensity score for post-election protest in each case, using only pre-election variables as predictors. I then use this propensity score for protest to model the level of electoral manipulation that in fact occurs. Deterrence models would expect that a higher propensity for protest would be associated with lower levels of manipulation, while the 'regime-strength' approach predicts the opposite. 
