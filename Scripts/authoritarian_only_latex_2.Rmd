...
Fundamentally, both set of models share the assumption that protest is a centralized, strategic decision by opposition groups, and that fraud is a tool employed by weak (i.e. unpopular) incumbents. As a result, they predict that the highest risk of protest should obtain when incumbents use massive fraud but still produce a low incumbent vote-share, indicating that the incumbent's true popularity is very low. This, in turn, indicates to opposition actors that protest is more likely to succeed in unseating the incumbent. Incumbents in these models typically face a tradeoff between the short-term benefits of electoral manipulation for winning the election, and any weakness that relying on fraud reveals to the opposition [@Rozenas2016b]. As Beaulieu [-@Beaulieu2014a, p. 48] writes in this tradition, "As the opposition grows stronger, the amount of [manipulation] he will tolerate shrinks, and the incumbent who wishes to avoid protest will need to reduce the amount of manipulation she commits." These are normatively optimistic models upon which a sizable literature has been founded: fraud can be kept in check, and ultimately reduced, through the development of institutions that reveal information about election integrity: election monitoring [@Hyde2014;@daxecker2012], more independent courts [@chernykh2015third], media activity [@naiFourthEstate], and civil society coordination [@birch2017getting]. These institutions improve election integrity, it is claimed, by increasing the likelihood that fraud will be observed and thus, incumbent weakness exposed.

However, an alternative set of models have also been advanced. A second worldview argues that election manipulation can indicate a well-resourced, well-organized, powerful incumbent (independent of its popularity). Under this view, extensive election manipulation can be a show of strength, which induces cooperation with the incumbent from other societal actors. Since this view holds that more manipulation can further entrench the incumbent, it is a normatively pessimistic view.

Most persuasively articulated by Simpser [-@simpser2013], this view holds that election manipulation demonstrates incumbent strength. As he writes, an incumbent that demonstrates the ability to engage in widespread manipulation "is also likely to have the resources, capacities, and inclinations to overcome or punish opponents, reward supporters, and circumvent the law" [@simpser2013, p. 6]. A relatively popular incumbent ("strong" in the language used by the first set of models) may nonetheless manipulate heavily in order to produce a very large majority [@magaloni2006], to induce regime insiders to remain cooperative [@gehlbach2015electoral], or because of a bandwagon effect among front-line agents [@rundlett2016deliver]. By demonstrating otherwise difficult-to-observe capabilities, large-scale election manipulation can solve a coordination problem for the incumbent, securing the cooperation of elites [@simpser2013]. This can, in turn, fix expectations that the incumbent will continue to rule in the future, further enhancing its staying power [@hale_patronal_2014]. This argument is in keeping with Seeberg's [-@Seeberg2019] finding that higher-capacity states are associated with more election fraud.

If election manipulation can be an indicator of regime strength, it may serve to deter protest under some circumstances, rather than the other way around [@simpser2013]. This leaves protest, when it does occur in the presence of large-scale manipulation, as something of a puzzle if protest behavior is largely strategic. For this reason, the manipulation-as-strength view comports more easily with another established view of the causes of electoral protest. Researchers in this tradition have argued that electoral protest occurs largely unrelated to strategic concerns about the relative strength of the incumbent and the opposition. In these models, electoral protest occurs because manipulation galvanizes citizens who hold diverse grievances, because economic conditions are poor, or simply because the bare fact of holding an election creates a moment of opportunity for opposition organization irrespective of the level of manipulation [@Pop-Eleches2015]. The central feature of these models is that protest decisions are generally made without consideration for the likelihood that protests will overthrow the incumbent.^[To be clear, this is the narrow sense in which 'strategic' and 'non-strategic' is used here and in protest-deterrent models. Protest behavior may still be rational in a broader sense without being narrowly tied to the expected likelihood of ousting the government. For instance, protesters may believe it is unlikely they will be individually punished for participating in protests, making it individually rational for them to voice their grievances.]
...
Taking this all together, it becomes clear that if researchers focus only on protest occurrence as a dependent variable, they cannot distinguish between two possible data-generating processes: one in which manipulation signals weakness and electoral protest is a strategic response, and one in which electoral manipulation indicates regime strengths and protest occurs for a variety of reasons with limited connection to the odds of removing the government. In the former, protest is predicted to occur most often when manipulation is high and the incumbent's vote-share is low, since this provides a strong signal that the incumbent's true popularity is low. In the latter, protest is most likely in the same condition because the incumbent's low popularity indicates widespread grievances, which the high level of manipulation serves to coordinate despite the incumbent's organizational strengths. Which of these data-generating processes predominates is of significant theoretical importance of understanding authoritarianism and democratization, since the latter view suggests much dimmer prospects for democratization than the former.
...
Since the empirical record is mixed, and two theories make similar predictions with regard to protest initiation, it is necessary to generate new hypotheses that can distinguish between the two models of election manipulation and protest that have been advanced. In particular, do post-election protest movements encounter weak incumbents as signaling models predict? If not, the deterrence model is undermined.
