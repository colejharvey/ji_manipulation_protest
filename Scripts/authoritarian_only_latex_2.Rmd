...
The stakes of this debate are significant. The former view is an optimistic one; in it, incumbents may restrain fraud when it might be exposed and reveal their weakness to strategic protesters\textemdash an auspicious prediction for democratization and ultimately the under-pinning of 'self-enforcing' democracy [@fearon_self-enforcing_2011]. If the latter view holds, non-strategic electoral protest may fail to deter election manipulation. The risk of mass protest would, in this case, be a fragile guardrail against autocratization. This debate cannot be advanced by focusing solely on protest occurrence. Instead, this paper contributes by drawing out implications from three strands of the literature on election manipulation and protest, which have (to my knowledge) not previously been explicated. 

In short: there are two views on the nature of electoral protest which make the same prediction. If opposition groups strategically initiate protest when they believe the incumbent to be weak, they will be most likely to do so when the election results show a low vote-share for the incumbent combined with high levels of manipulation\textemdash a combination of factors which reveals the incumbent's very low genuine popularity [@Luo2017;@Little2012;@Schedler2002;@Beaulieu2014a]. However, if protest movements are more organic and non-strategic, reflecting citizen grievances, we should expect protest initiation in the same circumstances. Here the combination of low incumbent vote-share and high manipulation indicates severe citizen grievances (low natural popularity) which are galvanized by the shared grievance of a 'stolen' election [@tucker2007]. Since both theories make the same prediction about protest initiation, such tests\textemdash which have been the dominant empirical measure in the literature\textemdash do not reveal whether protest is strategic and manipulation indicates weakness or if manipulation is a hallmark of strong incumbents [@simpser2013] and protest is non-strategic.   

To unravel this question, I take this analysis one step further. In strategic-protest models, the opposition protests because it believes the probability of a pro-government outcome of the protest is low. I assume that the duration of protest movements, when they occur, is an indicator of this latent likelihood of a pro-government outcome. The more quickly a government puts down protests, the greater the underlying (unobserved) distribution of power favors the incumbent over the opposition. By contrast, the longer it takes the government to restore control, the less favorable the distribution of power.^[The analysis treats the small number of cases where the opposition succeeds in ousting the government in several ways. They are excluded from the main analysis, but incorporated in a robustness check.]
